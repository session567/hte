...
import { calcBonuses, SkillBonuses } from '@modules/skill-bonus/utils'
...
const createBonusBars = (skillBar: HTMLDivElement, bonuses: SkillBonuses): HTMLDivElement[] => {
  ...
  Object.entries(bonuses).forEach(([bonusType, bonusValue]) => {
    ...
    bonusBar.title = t(`skill_bonus_${bonusType}`, [bonusValue.toFixed(2)])
