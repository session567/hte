...
test('should add denomination number after link', () => {
  document.body.innerHTML =
...
test('should not add denomination number after link if it already exists', () => {
  document.body.innerHTML = `
    <a href="/Help/Rules/AppDenominations.aspx?lt=skill&amp;ll=6#skill" class="skill">passable</a>
...
test('should add personality number after link for personality types', () => {
  document.body.innerHTML = `
